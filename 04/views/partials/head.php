            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="<?= urlIs(
                            '/'
                        ) ? 'bg-gray-900 text-white' : 'text-gray-300' ?>  hover:bg-gray-700 hover:bg-white/5 hover:text-white rounded-md  px-3 py-2 text-sm font-medium">Home</a>
                        <?php
                        if ($_SESSION['user'] ?? false) : ?>
                            <a href="/notes" class="<?= urlIs(
                                '/notes'
                            ) ? 'bg-gray-900 text-white' : 'text-gray-300' ?>   hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Notatki </a>
                        <?php
                        endif; ?>
                        <a href="/contact" class="<?= urlIs(
                            '/contact'
                        ) ? 'bg-gray-900 text-white' : 'text-gray-300' ?>   hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Kontakt</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <?php
                                ...
                                <a href="/register" class="<?= urlIs(
                                    '/register'
                                ) ? 'bg-gray-900 text-white' : 'text-gray-300' ?>   hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Register</a>
                                <a href="/login" class="<?= urlIs(
                                    'login'
                                ) ? 'bg-gray-900 text-white' : 'text-gray-300' ?>   hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">Log
                                    in </a>
                            <?php
                            endif; ?>
                        </div>
                    ...
                    <?php
                    if ($_SESSION['user'] ?? false) : ?>
                        <div class="ml-3 hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium">
